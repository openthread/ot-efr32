...
#define SL_MBEDTLS_SSL_IN_CONTENT_LEN 900 /**< Maximum fragment length in bytes */
#else
#define SL_MBEDTLS_SSL_IN_CONTENT_LEN 768 /**< Maximum fragment length in bytes */
#endif
...
#if OPENTHREAD_CONFIG_COAP_SECURE_API_ENABLE
#define SL_MBEDTLS_SSL_OUT_CONTENT_LEN 900 /**< Maximum fragment length in bytes */
#else
#define SL_MBEDTLS_SSL_OUT_CONTENT_LEN 768 /**< Maximum fragment length in bytes */
#endif
