...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/Users/jenkinsadmin/local/bin',
 'BINLIBDEST': '/Users/jenkinsadmin/local/lib/python3.10',
 'BLDLIBRARY': '-L. -lpython3.10',
 'BLDSHARED': 'gcc -bundle -undefined dynamic_lookup '
              '-Wl,-rpath,/Users/jenkinsadmin/local/lib '
              '-L/usr/local/opt/zlib/lib -L/usr/local/opt/bzip2/lib '
              '-L/usr/local/opt/openssl@1.1',
 'BUILDEXE': '.exe',
 'BUILDPYTHON': 'python.exe',
 'BUILD_GNU_TYPE': 'x86_64-apple-darwin21.5.0',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc',
 'CCSHARED': '',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-fwrapv -O3 -Wall -Wno-implicit-function-declaration '
           '-Wno-incompatible-pointer-types -I/usr/local/opt/zlib/include '
           '-I/usr/local/opt/bzip2/include',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '-fno-strict-aliasing',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-Wno-implicit-function-declaration '
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,-rpath,/Users/jenkinsadmin/local/lib '
                      '-L/usr/local/opt/zlib/lib -L/usr/local/opt/bzip2/lib '
                      '-L/usr/local/opt/openssl@1.1',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--enable-shared' '--prefix=/Users/jenkinsadmin/local' "
                "'LDFLAGS=-Wl,-rpath,/Users/jenkinsadmin/local/lib "
                '-L/usr/local/opt/zlib/lib -L/usr/local/opt/bzip2/lib '
                "-L/usr/local/opt/openssl@1.1' "
 ...
 'CONFINCLUDEDIR': '/Users/jenkinsadmin/local/include',
 'CONFINCLUDEPY': '/Users/jenkinsadmin/local/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Users/jenkinsadmin/george/python/Python-3.10.5/coverage.info',
 'COVERAGE_REPORT': '/Users/jenkinsadmin/george/python/Python-3.10.5/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++',
 'DESTDIRS': '/Users/jenkinsadmin/local /Users/jenkinsadmin/local/lib '
             '/Users/jenkinsadmin/local/lib/python3.10 '
             '/Users/jenkinsadmin/local/lib/python3.10/lib-dynload',
 'DESTLIB': '/Users/jenkinsadmin/local/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/Users/jenkinsadmin/local/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'x86_64-apple-darwin21.5.0',
 'INCLDIRSTOMAKE': '/Users/jenkinsadmin/local/include '
                   '/Users/jenkinsadmin/local/include '
                   '/Users/jenkinsadmin/local/include/python3.10 '
                   '/Users/jenkinsadmin/local/include/python3.10',
 'INCLUDEDIR': '/Users/jenkinsadmin/local/include',
 'INCLUDEPY': '/Users/jenkinsadmin/local/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/Users/jenkinsadmin/local/lib/python3.10',
 'LIBDIR': '/Users/jenkinsadmin/local/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Users/jenkinsadmin/local/lib/pkgconfig',
 'LIBPL': '/Users/jenkinsadmin/local/lib/python3.10/config-3.10-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Users/jenkinsadmin/local/lib/python3.10',
 'MACOSX_DEPLOYMENT_TARGET': '12.4',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/Users/jenkinsadmin/local/share/man',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '-Wno-incompatible-pointer-types '
                             '-I/usr/local/opt/zlib/include '
                             '-I/usr/local/opt/bzip2/include -std=c99 -Wextra '
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -fwrapv -O3 -Wall -Wno-implicit-function-declaration '
              '-Wno-incompatible-pointer-types -I/usr/local/opt/zlib/include '
              '-I/usr/local/opt/bzip2/include',
 ...
 'PY_CORE_LDFLAGS': '-Wl,-rpath,/Users/jenkinsadmin/local/lib '
                    '-L/usr/local/opt/zlib/lib -L/usr/local/opt/bzip2/lib '
                    '-L/usr/local/opt/openssl@1.1',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-rpath,/Users/jenkinsadmin/local/lib '
               '-L/usr/local/opt/zlib/lib -L/usr/local/opt/bzip2/lib '
               '-L/usr/local/opt/openssl@1.1',
 'PY_LDFLAGS_NODIST': '',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_LIBRARY_PATH=/Users/jenkinsadmin/george/python/Python-3.10.5',
 'SCRIPTDIR': '/Users/jenkinsadmin/local/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_LIBRARY_PATH=/Users/jenkinsadmin/george/python/Python-3.10.5 '
               './python.exe',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_LIBRARY_PATH=/Users/jenkinsadmin/george/python/Python-3.10.5 '
 ...
 'abs_builddir': '/Users/jenkinsadmin/george/python/Python-3.10.5',
 'abs_srcdir': '/Users/jenkinsadmin/george/python/Python-3.10.5',
 'datarootdir': '/Users/jenkinsadmin/local/share',
 'exec_prefix': '/Users/jenkinsadmin/local',
 'prefix': '/Users/jenkinsadmin/local',
 'srcdir': '.'}
